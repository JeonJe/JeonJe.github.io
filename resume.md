...
const resumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      achievements: [
        ...
        "SSL-VPN 정책 자동화 개선 프로젝트 PM (매출 1억)",
  ...
  projects: [
    ...
    {
      title: "재택근무 급증 대응, ACL 임계치 해결 (매출 1억+)",
